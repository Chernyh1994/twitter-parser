    ...
    <v-layout row wrap align-center>
        <v-flex>
            ...
            >
                <v-img
                height="100%"
                src="https://images.wallpaperscraft.ru/image/gory_gornyj_hrebet_vershiny_150275_3840x2160.jpg"
                >
                <v-row>
                    <v-col>
                    <v-list-item
                    ...
                    >
                        <v-list-item-content>
                            ...
                            <v-list-item-title class="title">Role: {{user.role}}</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                    </v-col>
                </v-row>
